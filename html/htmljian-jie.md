...
```
上一段HTML文本中，<header><div>这类的带尖括号的玩意儿叫标签，标签描述了文本的作用，比如<p>标签表示其内部的文本是一个段落，<a>标签标识内部的文本是超链接等；与此同时，通过标签的互相嵌套，表示了这个文档的结构。至于哪个标签表示什么意思、总共有多少个种类的标签这类的问题，由W3C(万维网联盟)这一组织规定。
